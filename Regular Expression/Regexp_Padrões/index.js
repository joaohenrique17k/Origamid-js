...
for(cep of ceps) {
  console.log(cep, cep.match(regexpCEP)); // 00000-000 [ '00000-000' ] 00000 000 [ '00000 000' ]  00000000 [ '00000000' ] 
}
...
for(cpf of cpfs) {
  console.log(cpf, cpf.match(regexpCPF));   //000.000.000-00 [ '000.000.000-00' ] 
